...
public class VirtualKeys1 {
	...
	public VirtualKeys1(View v, GameKeyListener l) {
		view = v;
		...
		//selectStart = createControl(R.drawable.select_start);
	...
	private int getButtonsStates(float x, float y, float size) {
		...
		if (size > pointSizeThreshold) {
			...
			case Emulator.GAMEPAD_B:
				states = (Emulator.GAMEPAD_B);
				break;
			case Emulator.GAMEPAD_A:
				states = (Emulator.GAMEPAD_A);
				break;
			}
		}
		return states;
